...
export default function BookingBody(props: Props) {
            ...
            return res.map((user,index) => {
                return (
                    <div key={index} className="row my-3 d-flex align-items-center" data-bs-theme='dark'>
                        ...
                        <p className={`${!theme.theme && 'dark'} col-xxl-1 col-xl-1 col-lg-1 col-md-1 col-sm-4 col-4 m-0 ps-2 fw-normal text-light-emphasis d-flex flex-row`}>{user.first_name}</p>
                        <p className={`${!theme.theme && 'dark'} col-xxl-7 col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 m-0 fs-5 fw-bolder text-primary d-flex justify-content-xxl-start justify-content-xl-start justify-content-lg-start justify-content-md-start justify-content-sm-center justify-content-center`}>
                            {user.email}
                        </p>
                        <button type="button"
    ...
    return (
            <div className={`container p-5 mt-2 booking_body rounded-4 ${!theme.theme && 'dark'}`}>
                    {renderData()}
